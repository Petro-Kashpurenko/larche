(function ($) {
   ...
   */
  Drupal.theme.prototype.larcheExampleButton = function (path, title) {
   ...
   */
  Drupal.behaviors.larcheExampleBehavior = {
    attach: function (context, settings) {
      ...
      $('.some-selector', context).once('foo', function () {
        ...
        var $anchor = Drupal.theme('larcheExampleButton', settings.myExampleLinkPath, settings.myExampleLinkTitle);
